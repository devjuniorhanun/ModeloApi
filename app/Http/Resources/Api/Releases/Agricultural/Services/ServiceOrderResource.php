...
class ServiceOrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'operators' => $this->operators->map(function ($operator) {
                return [
                    'operator_name' => $operator->agriculturalOperator->employee->name,
                    'fleet_name' => $operator->fleet ? $operator->fleet->name : null,
